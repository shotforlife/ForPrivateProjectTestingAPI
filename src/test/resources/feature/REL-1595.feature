@ST_4670 @tagtagtag @this_is_story_tag
...
@SC_30840 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_30841 @third_scenario_tag
...
@SC_30842 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_30843 @fifth_scenario_tag
